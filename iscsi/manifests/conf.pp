...
define iscsi::conf(
    ...
    $isns_address = "",
    $isns_port = "",
    $node_conn0_iscsi_DataDigest = "",
    $node_conn0_iscsi_HeaderDigest = "",
    $node_conn0_iscsi_MaxRecvDataSegmentLength = "",
    $node_conn0_timeo_login_timeout = "",
    $node_conn0_timeo_logout_timeout = "",
    $node_conn0_timeo_noop_out_interval = "",
    $node_conn0_timeo_noop_out_timeout = "",
